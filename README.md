...
- **裁判员管理**：支持主裁判员、第一助理裁判员、第二助理裁判员和第四官员信息的录入和展示
- **用户认证**：完整的登录/注册功能，使用姓名、学院、年级和密码进行认证
- **数据存储**：使用JSON文件存储比赛数据和用户信息
- **Node.js服务器**：提供API接口，实现数据的实时更新和管理
...
- 服务器默认运行在3000端口，如需修改请编辑server.js文件
- 数据存储在JSON文件中，建议定期备份
